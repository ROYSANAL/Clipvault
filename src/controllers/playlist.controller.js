...
//       // Match the playlist by the owner's userId and playlistId
//       {
//         $match: {
//           owner: new mongoose.Types.ObjectId(userId),
//           _id: new mongoose.Types.ObjectId(playlistId),
...
//       // Lookup the videos array and join each video with the "videos" collection
//       {
//         $lookup: {
//           from: "videos",
...
//       // Unwind the "videos" array to handle each video separately
//       {
//         $unwind: "$videos",
//       },

//       // Lookup to join the "owner" field from the "users" collection (users table)
//       {
//         $lookup: {
//           from: "users",
//           localField: "videos.owner", // The `owner` field inside each `video`
//           foreignField: "_id", // Matching against the _id of users
//           as: "ownerDetails", // This will store the joined user data in a new field
//         },
//       },
//       {
//         $unwind: "ownerDetails",
...
//       // Optionally, unwind ownerDetails if you want a flat structure
//       // {
//       //   $unwind: "$videos.ownerDetails", // Unwind the ownerDetails array, just in case
//       // },
//     ]);
